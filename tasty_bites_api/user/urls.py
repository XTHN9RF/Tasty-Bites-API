...
urlpatterns = [
    path('register/', UserRegistrationView.as_view({'post': 'create_user'}), name='register'),
    ...
    path('activate/<str:token>/', UserActivationView.as_view({'get': 'activate_user'}), name='activate_user'),
]
